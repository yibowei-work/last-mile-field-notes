...
const uiCopy = {
  en: {
    ...
    heroTitle: "Turn everyday last-mile shifts into", heroEmphasis: "decisions you can use.", heroText: "Tracking instant retail, local delivery, international logistics and rider-regulation shifts across China, Southeast Asia, Latin America and the Middle East.", briefButton: "View Instant Delivery Brief", allIntel: "Browse all intelligence", dailyPulse: "DAILY PULSE", dailyReady: "Daily refresh is ready", lastCheck: "Last check", refreshSchedule: "· checks the previous day every day at 08:30 (Shenzhen time).", refresh: "Refresh records ↻",
    stats: "Intelligence statistics", collected: "Collected intelligence", currentFilter: "Current filter", fulfillment: "Fulfillment", fulfillmentFoot: "Instant retail · delivery · logistics", other: "Other intelligence", otherFoot: "Industry and adjacent shifts", briefIndex: "01", briefTitle: "Instant Delivery Brief", briefEmpty: "No platform-side items match the current filters. Clear the month or other filters to see eligible items.", briefCount: "View all", source: "View original", productImpact: "Product impact", feedIndex: "02", feedTitle: "Intelligence Flow", feedSubtitle: "Track product, fulfillment, rider operations and regulatory shifts by business subject and scenario.", board: "Board", table: "Table", allMonths: "All months", allRegions: "All regions", allSubjects: "All business subjects", allScenarios: "All business scenarios", searchPlaceholder: "Search companies, markets or keywords", searchAria: "Search companies, markets or keywords", byMonth: "Filter by month", byRegion: "Filter by region", bySubject: "Filter by business subject", byScenario: "Filter by business scenario", query: "Query", add: "＋ Add intelligence", export: "Export CSV", sourceCoverage: "Additional platform announcements, open platforms, app releases, investor relations, regional media and regulatory sources", expandSources: "Expand", records: "records", newestFirst: "Sorted by occurrence · newest first", impact: "→ Product impact", materials: "Source ↗", time: "Time", regionMarket: "Region / market", company: "Company", subject: "Business subject", scenario: "Business scenario", change: "Change", status: "Status", open: "Open ↗", footerEyebrow: "RESEARCH LOG / JUL 2026", footerText: "Sources prioritize government and regulatory bodies, company announcements, developer documentation, authoritative media and regional regulatory materials. Manually added records are marked for review by default.", covered: "regions covered", daily: "Daily refresh · UTC+8", quickCapture: "QUICK CAPTURE", addTitle: "Add one intelligence item", occurred: "Occurred on", companyOrg: "Company / institution", region: "Region", countryCity: "Country / city", title: "Title", titlePlaceholder: "What changed?", changeContent: "Change summary", changePlaceholder: "Record the change in 1–2 sentences", materialLink: "Source link", cancel: "Cancel", save: "Save record", close: "Close", verified: "Verified", review: "Review", filterApplied: "Filters applied; the list is sorted newest first.", refreshDone: "Local record check complete; new items can be added with “Add intelligence”.", added: "Added 1 intelligence item; it is marked for review.", exported: "Exported", manual: "Manual entry", languageSwitch: "Language", zh: "中文", en: "EN"
  },
  zh: {
    backToTop: "返回顶部", live: "实时监测", firstOrganized: "首期整理 · 2026 年 7 月", kicker: "INSTANT SERVICE / FIELD NOTES", brand: "即时履约情报台",
    heroTitle: "把每一天的末端变化，", heroEmphasis: "变成可用判断。", heroText: "聚合中国、东南亚、拉美与中东的即时零售、同城配送、国际物流和运力监管动态。", briefButton: "查看即时配送简报", allIntel: "浏览所有情报", dailyPulse: "DAILY PULSE", dailyReady: "每日刷新入口已就绪", lastCheck: "上次检查", refreshSchedule: "· 每天 08:30（深圳时间）检查前一天内容。", refresh: "刷新记录 ↻",
    stats: "情报统计", collected: "已收录情报", currentFilter: "当前筛选", fulfillment: "物流履约", fulfillmentFoot: "即时零售 · 配送 · 国际物流", other: "其他情报", otherFoot: "行业与关联变化", briefIndex: "01", briefTitle: "即时配送简报", briefEmpty: "当前筛选下没有符合条件的平台侧情报。清除年月或其他筛选后，可查看符合条件的内容。", briefCount: "查看全部", source: "查看原文", productImpact: "产品影响", feedIndex: "02", feedTitle: "情报流", feedSubtitle: "按业务主体与业务场景追踪产品、履约、运力与监管变化。", board: "看板", table: "表格", allMonths: "全部年月", allRegions: "全部区域", allSubjects: "全部业务主体", allScenarios: "全部业务场景", searchPlaceholder: "搜索公司、市场、关键词", searchAria: "搜索公司、市场、关键词", byMonth: "按年月筛选", byRegion: "按区域筛选", bySubject: "按业务主体筛选", byScenario: "按业务场景筛选", query: "查询", add: "＋ 新增情报", export: "导出 CSV", sourceCoverage: "补充平台公告、开放平台、App 版本、投资者关系、区域媒体与监管入口", expandSources: "展开", records: "条记录", newestFirst: "按发生时间倒序 · 越新的变化越靠前", impact: "→ 产品影响", materials: "资料 ↗", time: "时间", regionMarket: "区域 / 市场", company: "公司", subject: "业务主体", scenario: "业务场景", change: "改动内容", status: "状态", open: "打开 ↗", footerEyebrow: "RESEARCH LOG / JUL 2026", footerText: "来源以政府、公司公告、开发者文档、权威媒体与区域监管资料为主。手工新增记录默认标为“待复核”。", covered: "覆盖区域", daily: "每日刷新 · UTC+8", quickCapture: "QUICK CAPTURE", addTitle: "新增一条情报", occurred: "发生时间", companyOrg: "公司 / 机构", region: "区域", countryCity: "国家 / 城市", title: "标题", titlePlaceholder: "这条变化发生了什么？", changeContent: "改动内容", changePlaceholder: "用 1-2 句话记录改动内容", materialLink: "资料链接", cancel: "取消", save: "保存记录", close: "关闭", verified: "已核验", review: "待复核", filterApplied: "筛选条件已应用，列表已按发生时间倒序更新。", refreshDone: "已完成本地记录检查；新消息可通过“新增情报”补录。", added: "已新增 1 条情报，状态为“待复核”。", exported: "已导出", manual: "手工补录", languageSwitch: "语言", zh: "中文", en: "EN"
  }
} as const;
...
export default function Home() {
  ...
  return (
    <main className="shell">
      ...
      <section className="section-head feed-heading" id="feed"><div><span className="section-index">{ui.feedIndex}</span><h2>{ui.feedTitle}</h2></div><div className="feed-heading-right"><span className="section-caption">{ui.feedSubtitle}</span><div className="view-switch"><button className={view === "brief" ? "active" : ""} onClick={() => setView("brief")}>{ui.board}</button><button className={view === "table" ? "active" : ""} onClick={() => setView("table")}>{ui.table}</button></div></div></section>
